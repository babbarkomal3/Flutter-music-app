...
class newMusicScreen extends StatefulWidget {
  ...
  newMusicScreen(
      ...
      required this.i,
      required this.newsongName,
      required this.newsingerName});
